    ...
    <body>
        ...
        <div>
            ...
            <div id="lastResult">
                ...
                <p id="lastTestComment">In deine letzten test, hast du <span id="correctWords"></span> von <span id="totalWords"></span> richtigen Worte. <a href="/de/tests/last-test" class="link">Details anzeigen.</a>.</p>
            ...
            <div>
                ...
                <button class="center" onclick="location.href='/de/tests/take-test';">Starten einen neuen test</button>
